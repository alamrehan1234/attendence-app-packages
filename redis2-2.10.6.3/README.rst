...
Redis2 is forked from the official redis version of 2.10.6, but it has modified the namespace of the python package.

Normally, use the version 2.xx of redis is
import redis
...
.. code-block:: pycon
    ...
    >>> from redis2.sentinel import Sentinel
